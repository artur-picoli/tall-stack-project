    ...
    <div class="grid grid-cols-1 gap-4">
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="flex w-full gap-3 ">
                ...
                <div class="w-1/2">
                    @if ($documentType == 1)
                        <x-input-cpf icon="identification" wire:model.lazy="identification_document" label="CPF" id="cpf" />
                    @elseif($documentType == 2)
                        <x-inputs.maskable icon="identification" mask="XXXXXXXXXXXXXXX" wire:model.lazy="identification_document"
                            label="RG" id="rg" />
